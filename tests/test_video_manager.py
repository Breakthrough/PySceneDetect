...
class TestVideoManager(unittest.TestCase):
    ...
    def test_start_stop(self):
        ...
        # be rogue, and be sure to call release() as well.
        #
        # The start/stop methods are the only big usage differences between the
        # VideoManager and cv2.VideoCapture objects (and setting start/end time).
        try:
            video_manager.start()
