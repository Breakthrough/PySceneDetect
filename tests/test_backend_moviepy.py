...
from scenedetect.video_stream import SeekError, VideoOpenFailure
...
class TestVideoStreamMoviePy:
    """Test cases for VideoStreamMoviePy backend."""
    ...
    def test_eof_detection(self, test_video_file):
        ...
        frame2 = video.read()
        # This might be False or the last frame depending on exact timing
    ...
    def test_seek_error_recovery(self, test_video_file):
        ...
        original_frame_number = video.frame_number
