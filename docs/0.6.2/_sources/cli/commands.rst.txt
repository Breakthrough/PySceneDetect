...
Load scenes from CSV instead of detecting. Can be used with CSV generated by :program:`list-scenes <scenedetect list-scenes>`. Scenes are loaded using the specified column as cut locations (frame number or timecode).
