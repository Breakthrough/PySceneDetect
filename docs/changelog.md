 ...
 * New detection algorithm `detect-adaptive` to greatly reduce false negatives during fast camera movement (thanks @scarwire and @wjs018)
 * Images generated by `save-images` can now be resized
