...
class CliContext:
    ...
    def handle_detect_hash(self, threshold: Optional[float], min_scene_len: Optional[str],
                           hash_size: Optional[int], highfreq_factor: Optional[int]):
        ...
        logger.debug(
            "Adding detector: HashDetector(threshold=%f, min_scene_len=%d,"
            " hash_size=%d, highfreq_factor=%d)", threshold, min_scene_len, hash_size,
            highfreq_factor)
